package com.sat.upload.service.impl;

import com.github.tobato.fastdfs.domain.StorePath;
import com.github.tobato.fastdfs.service.FastFileStorageClient;
import com.sat.common.enums.ExceptionEnum;
import com.sat.common.exception.SatException;
import com.sat.upload.config.UploadProperties;
import com.sat.upload.service.UploadService;
...
public class UploadServiceImpl implements UploadService {
    ...
    public String uploadImage(MultipartFile file) {
        ...
        if (!prop.getAllowTypes().contains(contentType)) {
            throw new SatException(ExceptionEnum.INVALID_FILE_FORMAT);
        }
        ...
        try {
            ...
            throw new SatException(ExceptionEnum.UPLOAD_IMAGE_EXCEPTION);
        }
