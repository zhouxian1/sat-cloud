...
import com.sat.service.mapper.SpecGroupMapper;
import com.sat.service.mapper.SpecParamMapper;
...
public class SpecServiceImpl implements SpecService {
    ...
    public List<SpecGroup> querySpecGroupByCid(Long cid) {
        ...
        if (CollectionUtils.isEmpty(specGroupList)) {
            throw new SatException(ExceptionEnum.SPEC_GROUP_NOT_FOUND);
        }
    ...
    public void saveSpecGroup(SpecGroup specGroup) {
        ...
        if (count != 1) {
            throw new SatException(ExceptionEnum.SPEC_GROUP_CREATE_FAILED);
        }
    }
    ...
    public void deleteSpecGroup(Long id) {
        ...
        if (count != 1) {
            throw new SatException(ExceptionEnum.DELETE_SPEC_GROUP_FAILED);
        }
    }
    ...
    public void updateSpecGroup(SpecGroup specGroup) {
        ...
        if (count != 1) {
            throw new SatException(ExceptionEnum.UPDATE_SPEC_GROUP_FAILED);
        }
    }
    ...
    public List<SpecParam> querySpecParams(Long gid, Long cid, Boolean searching, Boolean generic) {
        ...
        if (CollectionUtils.isEmpty(specParamList)) {
            throw new SatException(ExceptionEnum.SPEC_PARAM_NOT_FOUND);
        }
    ...
    public void saveSpecParam(SpecParam specParam) {
        ...
        if (count != 1) {
            throw new SatException(ExceptionEnum.SPEC_PARAM_CREATE_FAILED);
        }
    }
    ...
    public void updateSpecParam(SpecParam specParam) {
        ...
        if (count != 1) {
            throw new SatException(ExceptionEnum.UPDATE_SPEC_PARAM_FAILED);
        }
    }
    ...
    public void deleteSpecParam(Long id) {
        ...
        if (count != 1) {
            throw new SatException(ExceptionEnum.DELETE_SPEC_PARAM_FAILED);
        }
    }
