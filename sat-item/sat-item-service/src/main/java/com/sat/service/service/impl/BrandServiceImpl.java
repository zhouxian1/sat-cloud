...
import com.sat.service.mapper.BrandMapper;
...
public class BrandServiceImpl implements BrandService {
    ...
    public void saveBrand(Brand brand, List<Long> cids) {
        ...
        if (resultCount == 0) {
            throw new SatException(ExceptionEnum.BRAND_CREATE_FAILED);
        }
        //更新品牌分类表
        for (Long cid : cids) {
    ...
    public void updateBrand(BrandVo brandVo) {
        ...
        if (resultCount == 0) {
            throw new SatException(ExceptionEnum.UPDATE_BRAND_FAILED);
        }
    ...
    public void deleteBrand(Long bid) {
        ...
        if (result == 0) {
            throw new SatException(ExceptionEnum.DELETE_BRAND_EXCEPTION);
        }
        //删除中间表
